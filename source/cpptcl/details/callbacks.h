...
{
     typedef std::function<R(T1)> functor_type;
...
{
     typedef std::function<R(T1, T2)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4, T5)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4, T5, T6)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4, T5, T6, T7)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4, T5, T6, T7, T8)> functor_type;
...
{
     typedef std::function<R(T1, T2, T3, T4, T5, T6, T7, T8, T9)> functor_type;
