...
//
// Overhauled to not use Boost and support std::function - Tad Hardesty 2011
//
...
// binders for methods and methods_v
#include "details/binders.h"
...
public:
     ...
     template <typename R>
     void def(std::string const &name, std::function<R()> f,
          policies const &p = policies())
     {
          add_function(name,
     ...
     template <typename R, typename T1>
     void def(std::string const &name, std::function<R(T1)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     template <typename R, typename T1, typename T2>
     void def(std::string const &name, std::function<R(T1, T2)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     template <typename R, typename T1, typename T2, typename T3>
     void def(std::string const &name, std::function<R(T1, T2, T3)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     template <typename R, typename T1, typename T2, typename T3, typename T4>
     void def(std::string const &name, std::function<R(T1, T2, T3, T4)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     void def(std::string const &name, std::function<R(T1, T2, T3, T4, T5)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     void def(std::string const &name, std::function<R(T1, T2, T3, T4, T5, T6)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     void def(std::string const &name, std::function<R(T1, T2, T3, T4, T5, T6, T7)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     void def(std::string const &name, std::function<R(T1, T2, T3, T4, T5, T6, T7, T8)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
     ...
     void def(std::string const &name,
          std::function<R(T1, T2, T3, T4, T5, T6, T7, T8, T9)> f,
          policies const &p = policies())
     {
          add_function(name,
               std::shared_ptr<details::callback_base>(
