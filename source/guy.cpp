...
void Guy::MonsterControl(Map *map, world_t *world)
{
	...
	switch (type) {
		case MONS_BONEHEAD:
			AI_Bonehead(this, map, world, target);
			break;
		case MONS_BAT:
			AI_Bat(this, map, world, target);
			break;
		case MONS_SPIDER:
			AI_Spider(this, map, world, target);
			break;
		case MONS_BIGSPDR:
			AI_BigSpider(this, map, world, target);
			break;
		case MONS_ZOMBIE:
			AI_Zombie(this, map, world, target);
			break;
		case MONS_EGGSAC:
			AI_EggSac(this, map, world, target);
			break;
		case MONS_MAMASPDR:
			AI_MamaSpider(this, map, world, target);
			break;
		case MONS_PYGMY:
			AI_Pygmy(this, map, world, target);
			break;
		case MONS_SERPENT:
			AI_Serpent(this, map, world, target);
			break;
		case MONS_MATHEAD:
		case MONS_MATSKULL:
			AI_MattieSkullOrHead(this, map, world, target);
			break;
		case MONS_MATBRAIN:
			AI_MattieBrain(this, map, world, target);
			break;
		case MONS_MATBODY:
			AI_MattieBody(this, map, world, target);
			break;
		case MONS_MATCLAW1:
		case MONS_MATCLAW2:
			AI_MattieClaw(this, map, world, target);
			break;
		case MONS_MATTAIL:
			AI_MattieTail(this, map, world, target);
			break;
		case MONS_GINGER:
			AI_Ginger(this, map, world, target);
			break;
		case MONS_PUMPKIN:
		case MONS_BOOMKIN:
			AI_Pumpkin(this, map, world, target);
			break;
		case MONS_BABYTHING:
			AI_BabyThing(this, map, world, target);
			break;
		case MONS_MOSS:
			AI_Moss(this, map, world, target);
			break;
		case MONS_MOSSGRANDE:
			AI_MossGrande(this, map, world, target);
			break;
		case MONS_MAGMAZOID:
			AI_Magmazoid(this, map, world, target);
			break;
		case MONS_SHROOM:
			AI_Shroom(this, map, world, target);
			break;
		case MONS_MUSH:
			AI_Mush(this, map, world, target);
			break;
		case MONS_THING:
			AI_TheThing(this, map, world, target);
			break;
		case MONS_THINGTENT:
		case MONS_THINGTENTTIP:
			AI_ThingTentacle(this, map, world, target);
			break;
		case MONS_SUPERZOMBIE:
			AI_SuperZombie(this, map, world, target);
			break;
		case MONS_STICKMAN:
			AI_StickMan(this, map, world, target);
			break;
		case MONS_BABYSEAL:
			AI_BabySeal(this, map, world, target);
			break;
		case MONS_ISOZOID:
			AI_Isozoid(this, map, world, target);
			break;
		case MONS_SNOWGUY:
			AI_Snowguy(this, map, world, target);
			break;
		case MONS_PENGUIN:
			AI_Penguin(this, map, world, target);
			break;
		case MONS_ZOMBONI:
			AI_Zomboni(this, map, world, target);
			break;
		case MONS_SVEN:
		case MONS_BJORN:
			AI_Yeti(this, map, world, target);
			break;
		case MONS_GEOZOID:
			AI_Geozoid(this, map, world, target);
			break;
		case MONS_MUMBLE:
		case MONS_MUMBLE2:
			AI_Mumble(this, map, world, target);
			break;
		case MONS_DJINNI:
			AI_Djinni(this, map, world, target);
			break;
		case MONS_LAMP:
			AI_MagicLamp(this, map, world, target);
			break;
		case MONS_CACTUS:
			AI_Cactus(this, map, world, target);
			break;
		case MONS_ROLLER:
		case MONS_ROLLER2:
		case MONS_ROLLER3:
		case MONS_ROLLER4:
			AI_Roller(this, map, world, target);
			break;
		case MONS_LICH:
			AI_Lich(this, map, world, target);
			break;
		case MONS_DUSTDEVIL:
			AI_DustDevil(this, map, world, target);
			break;
		case MONS_MECHABOUAPHA:
			AI_MechaBouapha(this, map, world, target);
			break;
		case MONS_SPHXARM1:
		case MONS_SPHXARM2:
			AI_SphinxArm(this, map, world, target);
			break;
		case MONS_SPHINX:
			AI_Sphinx(this, map, world, target);
			break;
		case MONS_FREAKAZOID:
			AI_Freakazoid(this, map, world, target);
			break;
		case MONS_CENTIBODY:
			AI_CentiBody(this, map, world, target);
			break;
		case MONS_CENTIHEAD:
			AI_CentiHead(this, map, world, target);
			break;
		case MONS_WACKO:
			AI_Wacko(this, map, world, target);
			break;
		case MONS_BOILER:
			AI_Boiler(this, map, world, target);
			break;
		case MONS_GREATPK:
			AI_GreatPumpkin(this, map, world, target);
			break;
		case MONS_ULTRAZOID:
			AI_Ultrazoid(this, map, world, target);
			break;
		case MONS_DRL:
			AI_DrLunatic(this, map, world, target);
			break;
		case MONS_SDZL:
			AI_SDZL(this, map, world, target);
			break;
		case MONS_SANTA:
			AI_Santa(this, map, world, target);
			break;

#ifdef EXPANDO

		case MONS_MINECART:
			AI_MineCart(this, map, world, target);
			break;
		case MONS_RAFT:
			AI_Raft(this, map, world, target);
			break;
		case MONS_VAMPIRE:
		case MONS_DARKVAMP:
			AI_Vampire(this, map, world, target);
			break;
		case MONS_COFFIN:
			AI_Coffin(this, map, world, target);
			break;
		case MONS_GHOST:
			AI_Ghost(this, map, world, target);
			break;
		case MONS_BURNER:
			AI_Burner(this, map, world, target);
			break;
		case MONS_LEFTY:
			AI_Lefty(this, map, world, target);
			break;
		case MONS_PYGMY2:
			AI_Pygmy2(this, map, world, target);
			break;
		case MONS_PYGMY3:
			AI_Pygmy3(this, map, world, target);
			break;
		case MONS_PKSTEIN:
			AI_Pumpkinstein(this, map, world, target);
			break;
		case MONS_KNIGHT:
			AI_Knight(this, map, world, target);
			break;
		case MONS_TRICEROID:
			AI_Triceroid(this, map, world, target);
			break;
		case MONS_COUNTESS:
			AI_Countess(this, map, world, target);
			break;
		case MONS_ALIENEGG:
		case MONS_ALIENEGG2:
			AI_AlienEgg(this, map, world, target);
			break;
		case MONS_BABYALIEN:
			AI_BabyAlien(this, map, world, target);
			break;
		case MONS_ALIEN:
			AI_Alien(this, map, world, target);
			break;
		case MONS_ROBOPK:
			AI_Robopumpkin(this, map, world, target);
			break;
		case MONS_SHOCKTR:
			AI_ShockTrooper(this, map, world, target);
			break;
		case MONS_ROBOT1:
		case MONS_GOODROBOT:
			AI_Minibot(this, map, world, target);
			break;
		case MONS_ROBOT2:
		case MONS_GOODROBOT2:
			AI_Meaniebot(this, map, world, target);
			break;
		case MONS_ROBOFACTORY:
			AI_Robofactory(this, map, world, target);
			break;
		case MONS_TURRET:
			AI_Turret(this, map, world, target);
			break;
		case MONS_BUNNY:
			AI_Bunny(this, map, world, target);
			break;
		case MONS_KONGOR:
			AI_Kongor(this, map, world, target);
			break;
		case MONS_SQUASH:
			AI_Squash(this, map, world, target);
			break;
		case MONS_MINIPYGMY:
			AI_UltraPygmy(this, map, world, target);
			break;
		case MONS_LOONYBOT:
			AI_LoonyBot(this, map, world, target);
			break;
		case MONS_LOONYCORE:
			AI_LoonyCore(this, map, world, target);
			break;
		case MONS_LOONYGUN:
			AI_LoonyGun(this, map, world, target);
			break;
		case MONS_LOONYSHIP:
			AI_LoonyShip(this, map, world, target);
			break;
		case MONS_GOODTURRET:
			AI_GoodTurret(this, map, world, target);
			break;
		case MONS_MAT2HEAD:
		case MONS_MAT2SKULL:
			AI_Mattie2SkullOrHead(this, map, world, target);
			break;
		case MONS_MAT2BRAIN:
			AI_Mattie2Brain(this, map, world, target);
			break;
		case MONS_MAT2BODY:
			AI_Mattie2Body(this, map, world, target);
			break;
		case MONS_MAT2TAIL:
			AI_Mattie2Tail(this, map, world, target);
			break;
		case MONS_FRIENDLY:
		case MONS_FRIENDLY2:
			AI_BuddyBunny(this, map, world, target);
			break;
		case MONS_SHAMAN2:
			AI_PygmyQueen(this, map, world, target);
			break;
		case MONS_JALAPENO:
			AI_Jalapeno(this, map, world, target);
			break;
		case MONS_GENERATOR1:
		case MONS_GENERATOR2:
		case MONS_GENERATOR3:
		case MONS_GENERATOR4:
			AI_Generator(this, map, world, target);
			break;
		case MONS_SHARK:
			AI_Shark(this, map, world, target);
			break;
		case MONS_MADBUG:
			AI_MadBug(this, map, world, target);
			break;
		case MONS_WIZARD:
			AI_Wizard(this, map, world, target);
			break;
		case MONS_EVILCLONE:
			AI_EvilClone(this, map, world, target);
			break;
		case MONS_BOB:
			AI_Bob(this, map, world, target);
			break;
		case MONS_MULTIMOSS:
			AI_MultiMoss(this, map, world, target);
			break;
		case MONS_MOSS2:
			AI_MossRapido(this, map, world, target);
			break;
		case MONS_SNOWBALL:
		case MONS_SNOWBALL2:
			AI_Snowball(this, map, world, target);
			break;
		case MONS_SNOWBLOW:
			AI_Snowblower(this, map, world, target);
			break;
		case MONS_XENOMAMA:
			AI_XenoMama(this, map, world, target);
			break;
		case MONS_GNOME:
			AI_Gnome(this, map, world, target);
			break;
		case MONS_NOBODY:
			AI_Nobody(this, map, world, target);
			break;
		case MONS_PUMPKIN2:
			AI_BigPumpkin(this, map, world, target);
			break;
		case MONS_TROOPER2:
			AI_RockTrooper(this, map, world, target);
			break;
		case MONS_CRAZYBONE:
			AI_CrazyBone(this, map, world, target);
			break;
		case MONS_CREEPAZOID:
			AI_Creepazoid(this, map, world, target);
			break;
#endif
	}
}
